    ...
    <div className="card shadow mb-4">
      ...
      <div className="card-body">
        <div className="small text-gray-500 mb-3">
          Synced from the full-story coverage feed, auto-saved to MySQL, and displayed from random rows in the database.
        </div>
        ...
        {error ? (
          ...
          <div className="text-center text-gray-500 py-4">Syncing news coverage and loading database articles...</div>
        ) : cards.length > 0 ? (
